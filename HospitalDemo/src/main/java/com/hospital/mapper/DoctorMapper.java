...
public interface DoctorMapper {
    ...
    public int countHighPriority(Patient patient);
    public int countMiddlePriority(Patient patient);
    public int countLowPriority(Patient patient);
    ...
    public Patient getSinglePatientById(@Param("patientId") int patientId);
    ...
    public List<Reminder> getReminderOutdatedBySinglePatient(@Param("patientId")int patientId);
